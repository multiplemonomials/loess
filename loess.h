...
% the number of threads reported by the system.  If zero, the number of processors
...
%
%   Adapted to have a C++ API (instead of MATLAB) by Jamie Smith
*/
MatrixX1d loess(Eigen::MatrixXd x, MatrixX1d v, Eigen::MatrixXd xi, double span, size_t niter = 0, size_t order = 1, size_t nthreads=0);